...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.taskToShow = function (task) {
...
module.exports = "<h6>{{taskToShow.title}}</h6>\n<p>{{taskToShow.description}}</p>"
